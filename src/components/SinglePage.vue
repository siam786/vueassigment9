  ...
  <div class="bg-white py-25">
    <div class="flex justify-center items-center">
      <div class="mx-auto px-6 lg:px-8">
        <article
          v-if="post"
          class="flex flex-col items-start justify-between bg-gray-100 p-6 rounded-md"
        >
        ...
        >
          <h3 class="mt-3 text-lg font-semibold leading-6">
            <p>কোন পোস্ট নাই</p>
            <br />
            <span class="text-indigo-500 hover:text-indigo-900 cursor-pointer"
              ><router-link :to="{ name: 'home' }"
                >হোম ফেরে জান</router-link
              ></span
            >
          </h3>
        </article>
